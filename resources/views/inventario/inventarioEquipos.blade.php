                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item"><strong>Serial Físico Monitor:</strong> {{ $inventario->serial_fisico_monitor }}</li>
                                                <li class="list-group-item"><strong>Capacidad Disco:</strong> {{ $inventario->capacidad_disco }}</li>
                                                <li class="list-group-item"><strong>Tipo Disco:</strong> {{ $inventario->tipo_disco }}</li>
                                                ...
                                                <li class="list-group-item"><strong>Torre:</strong> {{ $inventario->torre }}</li>
